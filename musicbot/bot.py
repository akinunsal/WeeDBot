...
"""handle_<var> are commands
Made by akinunsal with heavy snips of code from SexualRhinoceros
Most of the work is done by him!
"""
...
class MusicBot(discord.Client):
    ...
    async def handle_makeitstop(self, player, channel, author):
        """
        ...
        if player.is_stopped: # TODO: or player.is_paused?
            raise CommandError("There's nothing to skip you moron.")
